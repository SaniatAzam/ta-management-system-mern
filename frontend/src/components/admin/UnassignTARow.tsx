...
import RemoveTAModal from "./RemoveTAModal";


const UnassignTARow = ({ course, fetchCourseData }: { course: Course; fetchCourseData: Function }) => {
  ...
  return (
    <tr className="body">
      <td className="column0">
        <RemoveTAModal courseNumber={courseNumber} term={term} year={year} cid={course_id} instructorID={course.instructor_user_id} />
      </td>
